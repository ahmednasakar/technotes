...
const NewUserForm = () => {
  ...
  // Validation effects for username and password
  useEffect(() => {
  ...
  // Effect to reset form after successful user addition
  useEffect(() => {
    if (isSuccess) {
      setUsername("");
      setPassword("");
  ...
  // Check if the form is ready for saving
  const canSave =
  ...
  // CSS classes for error messages and input validation
